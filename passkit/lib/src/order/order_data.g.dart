...
OrderData _$OrderDataFromJson(Map<String, dynamic> json) => OrderData(
      ...
      merchant:
          OrderMerchant.fromJson(json['merchant'] as Map<String, dynamic>),
      ...
      orderProvider: json['orderProvider'] == null
          ? null
          : OrderProvider.fromJson(
              json['orderProvider'] as Map<String, dynamic>),
      payment: json['payment'] == null
          ? null
          : OrderPayment.fromJson(json['payment'] as Map<String, dynamic>),
      returnInfo: json['returnInfo'] == null
          ? null
          : OrderReturnInfo.fromJson(
              json['returnInfo'] as Map<String, dynamic>),
...
Map<String, dynamic> _$OrderDataToJson(OrderData instance) => <String, dynamic>{
      ...
      'associatedApplicationIdentifiers':
          instance.associatedApplicationIdentifiers,
